                ...
                <div className='accordionContainer'>
                  <div className='accordiontext'>
                    ...
                    <p className='text'>
                      ...
                      `&quot`последнего груза`&quot` ниже уровня перрона.
                    </p>
                  </div>
                ...
                <div className='accordionContainer'>
                  <div className='accordiontext'>
                    ...
                    <p className='text'>
                      ...
                      называемого `&quot`почтового ящика`&quot`) под доклевеллером открытого или закрытого приямочного
                      типа. Передняя балка нижней рамы также служит для защиты гидравлической и механической систем,
                ...
                <div className='accordionContainer'>
                  <div className='accordiontext'>
                    <p className='text'>
                      ...
                      действий. Удерживая кнопку `&quot`Вверх`&quot`, платформа поднимается до нужной высоты для
                      загрузки. Затем, с помощью кнопки `&quot`Выдвинуть`&quot`, аппарель выдвигается для соединения с
                      полом кузова грузового транспортного средства. После отпускания кнопки обе части автоматически
                      опускаются на пол грузовика.
                    </p>
                    <p className='text'>
                      ...
                      перегрузочный мост в исходное положение с помощью кнопки `&quot`R`&quot`. После возврата в
                      исходное положение доклевеллер 233NG обеспечивает устойчивость, позволяя поперечное движение. Этот
                      перегрузочный мост идеально подходит для погрузки или разгрузки `&quot`последнего груза`&quot`
                      ниже уровня площадки.
                    </p>
                  </div>
                  <div className='boxImageContainer'>
                    <Image
                ...
                <div className='accordionContainer'>
                  <div className='accordiontext'>
                    ...
                    <p className='text'>
                      ...
                      Благодаря самонесущим свойствам рамы можно выбрать опцию `&quot`почтового ящика`&quot` под
                      доклевеллером открытого или закрытого приямочного типа. Передняя балка рамы также служит защитой
                      для гидравлической и механической систем, установленных в нижней части перегрузочного моста.
                    </p>
                  </div>
                </div>
              </ComponentAccordion>
